...
- [PortSwigger — SQL injection: retrieve hidden data (lab)](https://portswigger.net/web-security/sql-injection/lab-retrieve-hidden-data)  
  Interactive lab from PortSwigger/ Burp Suite that demonstrates extracting hidden data via SQL injection.
...
- [xkcd — "Exploits of a Mom" (comic #327)](https://xkcd.com/327/)  
  Classic xkcd comic about SQL injection.
